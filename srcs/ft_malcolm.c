...
/*   Updated: 2021/09/11 19:32:28 by cclaude          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main (int ac, char **av)
{
	...
	while (1)
	{
		packet_len = recvfrom(packet_socket, packet, 1000, 0, (struct sockaddr *)&addr, &addrlen);
	...
	my_mac(eth->h_source, addr.sll_ifindex);
